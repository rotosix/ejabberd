...
start_apps() ->
    ...
    %% begin modify by james.wu@asiainnovations 2014-10-9 PM 3:17
    ejabberd:start_app(ai_api),
    ejabberd:start_app(ai_proxy).
    %% end modify by james.wu@asiainnovations 2014-10-9 PM 3:17
