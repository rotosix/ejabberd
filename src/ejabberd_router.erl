...
do_route(OrigFrom, OrigTo, OrigPacket) ->
    ...
    %% begin add by james.wu@asiainnovations.com on 2014-12-22 PM 6:23
    Name = OrigPacket#xmlel.name,
    ToUid = OrigTo#jid.luser,

    %% 检查该用户是否可以发送消息，允许则发送，否则丢弃
    PermitSend = mod_ai_safe:check_send_permit(OrigFrom, OrigPacket),
    if PermitSend =:= true ->

    if Name =/= <<"message">>; ToUid =/= <<"">> ->
    %% end add by james.wu@asiainnovations.com on 2014-12-22 PM 6:23
    ...
    %% end add by james.wu@asiainnovations.com on 2015-1-12 PM 11:02
